...
public class TransferPage {
    ...
    public void transferMoney(String amountMoney, String cardNumber) {
        amountMoneyIn.setValue(amountMoney);
        topUpFromCard.setValue(cardNumber);
        topUpButton.click();
    }
    ...
    public DashboardPage validTransferMoney(String amountMoney, String cardNumber) {
        transferMoney(amountMoney, cardNumber);
